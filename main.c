...
////////////////////////////////////////////////////////////////////
//VARIABLES GLOBALES
int cantInt = 0; //VARIABLE GLOBAL ---> TAMA�O DEL VECTOR DE INTEGRANTES, BUSCAR ALTERNATIVA
int cantMat = 0;//VARIABLE GLOBAL ---> TAMA�O DEL VECTOR DE MATERIAS
...
//PYF VECTOR MATERIAS(MODIFICAR EL TAMA�O DE VectorMateria SI SE QUIERE EXPANDIR EL TXT)
...
int menu(){
    ...
    printf("1- ALTA\n"); //para m� hay que llamar a la funcion de listas "INSERTARFIN" y al terminar hacer un GRABADO en archivo txt con "a" o "w" seg�n convenga
    printf("2- MOSTRAR\n"); // procedimientos de cada procedimiento que est� ac� abajo en el MAIN por ahora (hasta ahora solo de vectorIntegrantes para la materia
    printf("3- ELIMINAR\n");//IDEM ALTA: hay que llamar a la funcion de listas, en este caso "REMOVER"
                            //y al terminar hacer un GRABADO en archivo txt con "a" o "w" seg�n convenga
    printf("4- MODIFICAR\n"); // SETTS de cada TDA
                            //y al terminar hacer un GRABADO en archivo txt con "a" o "w" seg�n convenga
...
void cargarVectorDeIntegrantes(Integrantes vectorIntegrantes[10]){
    ...
    cantInt = i; //VARIABLE GLOBAL ---> TAMA�O DEL VECTOR DE INTEGRANTES, BUSCAR ALTERNATIVA
}
